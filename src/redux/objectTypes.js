...
export const CURRENT = (gCost = 0, hCost = 0, fCost = 0, parent = undefined) => { return { value: 5, description: "Current", color: "#7eb8f2", gCost, hCost, fCost, parent } };
export const OPEN = (gCost = 0, hCost = 0, fCost = 0, parent = undefined) => { return { value: 7, description: "Open", color: "#DA93E6", gCost, hCost, fCost, parent }};
export const CLOSED = (gCost = 0, hCost = 0, fCost = 0, parent = undefined) => { return { value: 6, description: "Closed", color: "#E69383", gCost, hCost, fCost, parent }};
