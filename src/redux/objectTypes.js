...
export const CURRENT = { value: 5, description: "Current", color: "#C5E6C8" };

export const OPEN = (gCost = -1, hCost = -1, fCost = -1) => { return { value: 7, description: "Open", color: "#DA93E6", gCost: gCost, hCost: hCost, fCost: fCost }};
export const CLOSED = (gCost = -1, hCost = -1, fCost = -1) => { return { value: 6, description: "Closed", color: "#E69383", gCost: gCost, hCost: hCost, fCost: fCost }};
